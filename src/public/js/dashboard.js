...
let respuestasLocal = JSON.parse(localStorage.getItem("respuestasLocal")) || [];

function guardarRespuestaLocal(tipo, dia, horas) {
  respuestasLocal.push({ tipo, dia, horas, fecha: new Date() });
  localStorage.setItem("respuestasLocal", JSON.stringify(respuestasLocal));
}
